...
import {TimeSeriesChartProps} from "client/renderer/panes/electrophysiology/TimeSeriesChart";
...
export interface PulseChartState {
    // pulseData: any[]; // Array to store pulse data
}
export class PulseChart extends React.Component<PulseChartProps, PulseChartState> {
    constructor(props: PulseChartProps) {
        super(props)
        // this.state = {
        //     pulseData: [], // Initialize pulseData as an empty array
        // };
        // Initialize
